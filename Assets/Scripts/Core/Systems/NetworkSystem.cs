...
namespace Core.Systems {
	...
	public class NetworkSystem : BaseSystem<NetworkSystem> {
		...
		/// 服务器地址
		/// </summary>
		public const string ServerURL = DeployConfig.ServerURL;
		...
		public bool offline => 
			network == NetworkReachability.NotReachable;

		public bool localOnline => 
			network == NetworkReachability.ReachableViaLocalAreaNetwork;
		public bool carrierOnline => 
			network == NetworkReachability.ReachableViaCarrierDataNetwork;
		public bool online => localOnline || carrierOnline;
        ...
        public bool isConnected() {
            return isState(State.Connected);
        }
        ...
        /// </summary>
        public void clear() {
            successHandler = null; errorHandler = null;
            showLoading = true; tipsText = "";
        }
