...
namespace Core.Components {
	...
	public abstract class BaseScene : BaseComponent {
		...
		/// </summary>
		/// <returns>场景名</returns>
		SceneConfig.Type _sceneType = SceneConfig.Type.NoneScene;
		public virtual SceneConfig.Type sceneType {
			get {
				if (_sceneType == SceneConfig.Type.NoneScene)
					_sceneType = (SceneConfig.Type)Enum.Parse(
						typeof(SceneConfig.Type), GetType().Name);
				return _sceneType;
			}
		}
