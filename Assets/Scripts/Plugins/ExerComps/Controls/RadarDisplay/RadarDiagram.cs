...
namespace ExerComps.Controls.RadarDisplay {

    /// <summary>
    /// 雷达图控件
    /// </summary>
    public class RadarDiagram : CanvasComponent {
        ...
        public void activate(List<float> values) {
            base.activate(); setValues(values);
        }
        /// <param name="obj">可转化对象</param>
        /// <param name="type">类型</param>
        public void activate(IRadarDataConvertable obj, string type = "") {
            base.activate(); setValues(obj, type);
        }
